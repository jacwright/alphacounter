 ...
 */
inc.to = str => str.split('').reduce((acc, char) => acc * 62 + charsIndex[char], 0);
inc.toBig = str => str.split('').reduce((acc, char) => acc * BigInt(62) + BigInt(charsIndex[char]), BigInt(0));
